...
# Using the program:
I don't recommend cloning this directly (it appears some who have read my paper have tried this).  I run this code with a Python IDE (Spyder is my favorite for the live plots to "observe" the agents).
